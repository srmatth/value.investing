...
newdata <- most_recent %>%
  ...
  replace_na(
    list(
      avg_pct_change = mean(mod_dat$avg_pct_change, na.rm = TRUE),
      sd_pct_change = mean(mod_dat$sd_pct_change, na.rm = TRUE),
      avg_vol = mean(mod_dat$avg_vol, na.rm = TRUE),
      pe_ratio = mean(mod_dat$pe_ratio, na.rm = TRUE),
      price_to_sales_ratio = mean(mod_dat$price_to_sales_ratio, na.rm = TRUE),
      price_to_book_ratio = mean(mod_dat$price_to_book_ratio, na.rm = TRUE),
      price_to_fcf_ratio = mean(mod_dat$price_to_fcf_ratio, na.rm = TRUE),
      debt_to_equity_ratio = mean(mod_dat$debt_to_equity_ratio, na.rm = TRUE),
      pays_dividend = 0,
      dividend_yield = 0
    )
  )
